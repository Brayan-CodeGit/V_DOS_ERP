                ...
                <form method="POST" action="{{ route('admin.productos.update', $producto) }}">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="Codigo_SKU" class="block mt-1 w-full" type="text" name="Codigo_SKU" :value="old('Codigo_SKU', $producto->Codigo_SKU)" required />
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-4">
                        <div>
                            ...
                            <select id="Tipo_Producto" name="Tipo_Producto" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full" required>
                                ...
                                @foreach ($tipos as $tipo)
                                    <option value="{{ $tipo }}" @selected(old('Tipo_Producto', $producto->Tipo_Producto) == $tipo)>{{ $tipo }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <x-text-input id="Unidad_Medida" class="block mt-1 w-full" type="text" name="Unidad_Medida" :value="old('Unidad_Medida', $producto->Unidad_Medida)" required />
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-4">
                        <div>
                            ...
                            <x-text-input id="Costo_Estandar" class="block mt-1 w-full" type="number" step="0.01" name="Costo_Estandar" :value="old('Costo_Estandar', $producto->Costo_Estandar)" min="0" />
                        ...
                        <div class="flex items-end pb-1">
                            <label for="Es_Inventariable" class="flex items-center">
                                @php
                                    ...
                                    $checked = old('Es_Inventariable', $producto->Es_Inventariable);
                                @endphp
                                <input id="Es_Inventariable" name="Es_Inventariable" type="checkbox" @checked($checked) class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800">
